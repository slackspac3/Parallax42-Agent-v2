...
function inferReviewFocus(text = '', previousDraft = {}) {
  ...
  if (/\b(all of them|all of these|all of those|all of it|all of the above|all above|all listed|everything listed|everything|all material risks?|all risks?|full[- ]spectrum|end[- ]to[- ]end|all areas?)\b/i.test(clean)) {
