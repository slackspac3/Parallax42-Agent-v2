...
const CASES = [
  ...
  },
  {
    ...
    input: {
      ...
      geography: 'UAE',
      brief: 'Renew a low criticality consulting supplier with no personal data and no system integration.',
      documents: [{ summary: 'Signed contract, approval authority, no personal data statement, and security assurance review.' }]
    }
  }
];
