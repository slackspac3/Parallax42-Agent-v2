...
async function enrichConversationWithServerRetrieval(body = {}) {
  ...
  const existingGovernanceReferences = existingRetrieval.governanceReferences || [];
  const shouldRetrieveGovernance = Boolean((body.forceRun || governanceLikelyUseful) && !existingGovernanceReferences.length);
