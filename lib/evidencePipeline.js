...
async function indexEvidencePipeline(body = {}, options = {}) {
  return indexEvidenceServerSide(body, { actor: options.actor || options.auth?.actor });
}

async function searchEvidencePipeline(body = {}, options = {}) {
  return searchEvidenceServerSide(body, { actor: options.actor || options.auth?.actor });
}
