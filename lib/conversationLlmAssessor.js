...
const SMART_INTAKE_MALFORMED_DEGRADED_MESSAGE = 'Compass returned a malformed structured response, so I used deterministic intake for this turn. You can keep going or retry smart intake.';
...
function invalidResponseAssessment(extra = {}) {
  return unavailableAssessment(SMART_INTAKE_MALFORMED_DEGRADED_MESSAGE, {
    error: false,
