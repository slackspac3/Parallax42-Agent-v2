    ...
    return [
      {
        ...
        content: [
          ...
          'Use activeQuestion, currentEventType, conversationHistory, and currentDraft to interpret terse replies.',
  ...
  return [
    {
      ...
      content: [
        ...
        'If the latest user message is terse, interpret it using activeQuestion, currentEventType, conversationHistory, previousQuestions, and currentDraft.',
